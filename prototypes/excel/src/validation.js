export const checkINN = (inn, error) => {
    var result = false;
...
export const checkBIK = (bik, error) => {
	var result = false;
...
export const checkKPP = (kpp, error) => {
	var result = false;
...
export const checkKS = (ks, bik, error) => {
	var result = false;
	if (checkBIK(bik, error)) {
		if (typeof ks === 'number') {
			ks = ks.toString();
...
export const checkOGRN = (ogrn, error) => {
	var result = false;
...
export const checkOGRNIP = (ogrnip, error) => {
	var result = false;
...
export const checkRS = (rs, bik, error) => {
	var result = false;
	if (checkBIK(bik, error)) {
		if (typeof rs === 'number') {
			rs = rs.toString();
...
export const checkSNILS = (snils, error) => {
	var result = false;
